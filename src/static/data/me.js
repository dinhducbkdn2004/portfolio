const ME = {
    ...
    socials: [
        ...
        {
            icon: '/external/linkedin.svg',
            name: 'LinkedIn',
            link: 'https://www.linkedin.com/in/dinhducbkdn/',
        },
    ],
    ...
    experience: [
        {
            ...
            companyEn: 'Open Web Technology Vietnam',
            ...
            descriptionEn: [
                ...
                'Implemented complex state management logic using NGXS to ensure seamless data flow and application performance.',
                'Collaborated in a cross-functional team (BA, Backend, QA) to deliver a comprehensive Capstone Project, applying Agile principles with task tracking on GitHub.',
                'Enhanced self-research capabilities and problem-solving skills through hands-on coding and code reviews.',
            ],
        },
    ],
    ...
    activities: [
        ...
        },
        {
            ...
            periodEn: 'Sep 2023 - July 2024',
            description: [
                'Tình nguyện tham gia các hoạt động cộng đồng và dọn dẹp tại Hội người mù, Quận Liên Chiểu, Đà Nẵng.',
                'Tham gia tổ chức các sự kiện câu lạc bộ nhằm thúc đẩy kỹ năng giao tiếp và lãnh đạo.',
                'Rèn luyện các kỹ năng mềm như nói trước công chúng, làm việc nhóm và quản lý thời gian.',
            ],
            descriptionEn: [
                'Volunteered in community engagement and cleaning activities at the Blind Association, Lien Chieu District, Da Nang.',
                'Participated in organizing club events that fostered communication and leadership skills in a youth-driven environment.',
                'Trained in soft skills such as public speaking, teamwork, and time management through workshops led by experienced speakers.',
            ],
        },
    ],
    ...
    projects: [
        ...
        },
        {
            ...
            features: [
                'Phát triển backend FastAPI với REST APIs để xử lý hình ảnh/video và nhận diện cảm xúc.',
                'Xây dựng giao diện React phản hồi với tính năng tải lên hình ảnh, chụp webcam và render thời gian thực.',
                'Kích hoạt streaming thời gian thực qua Socket.IO với theo dõi khuôn mặt và làm mịn cảm xúc.',
            ],
            featuresEn: [
                'Developed FastAPI backend with REST APIs for image/video processing and emotion detection.',
                'Built a responsive React UI with image upload, webcam capture, and real-time rendering.',
                'Enabled real-time streaming via Socket.IO with face tracking and emotion smoothing.',
            ],
            link: 'https://emd.ducbkdn.space/',
            github: {
                frontend:
                    'https://github.com/dinhducbkdn2004/face-emotion-detection',
                backend:
                    'https://github.com/dinhducbkdn2004/face-emotion-detection-be',
            },
        },
        {
            name: 'WEBCHAT & VIDEO CALL REALTIME',
            type: 'Dự án nhóm',
            typeEn: 'Team project',
            teamSize: 3,
            ...
            features: [
                'Xây dựng cuộc gọi video dựa trên WebRTC và trò chuyện thời gian thực sử dụng PeerJS và Socket.IO.',
                'Phát triển giao diện React phản hồi với các component Ant Design.',
                'Tích hợp Google OAuth và thiết kế REST APIs cho quản lý người dùng & trò chuyện.',
                'Hỗ trợ tải lên tập tin sử dụng Cloudinary.',
            ],
            featuresEn: [
                'Built WebRTC-based video calling and real-time chat using PeerJS and Socket.IO.',
                'Developed a responsive React UI with Ant Design components.',
                'Integrated Google OAuth and designed REST APIs for user & chat management.',
                'Supported file uploads using Cloudinary.',
            ],
    ...
    ui: {
        vi: {
            ...
            projects: 'Dự án',
            programmingSkills: 'Ngôn ngữ lập trình',
            libraries: 'Frontend',
